    ...
    <main class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
        <div>
            <form show method="post" action='/checkpassword' class="flex flex-col">
                @csrf
                Neptun-Kód <input type="text" name="neptun" required value={{$neptun}} class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 px-3 pb-3"><br></br>
